...
public class TestMapUDF {
    ...
    public static void main(String[] args) {
        ...
        // TODO 2.注册函数
        tableEnv.createTemporaryFunction("UDF_MAP_PARAMS_HANDLE", UDF_MAP_PARAMS_HANDLE.class);
...
//                .print();
        ...
        // deleteData(MAP['id', id, 'name', name, 'age', age])
        tableEnv.sqlQuery("select sensorId, sensorName, UDF_MAP_PARAMS_HANDLE(MAP['sensorId', sensorId, 'sensorName', sensorName]) as id_and_name, ts, vc, dataCollectionLocation from sensor")
                .execute()  // 调用了 sql的execute，就不需要 env.execute()
                .print();
